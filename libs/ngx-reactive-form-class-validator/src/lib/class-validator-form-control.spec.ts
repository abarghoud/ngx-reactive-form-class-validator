...
describe('The ClassValidatorFormControl class', () => {
  let phoneNumberClassValidatorFormControl: ClassValidatorFormControl;

  beforeEach(() => {
    phoneNumberClassValidatorFormControl = new ClassValidatorFormControl('');
  });
  ...
  describe('When control name and classValue are provided', () => {
    ...
    describe('When combining dynamic class-validator and manual validation', () => {
      const emailClassValidatorFormControl = new ClassValidatorFormControl();
